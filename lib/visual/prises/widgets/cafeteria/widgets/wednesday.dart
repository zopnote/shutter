        ...
        Container(
          ...
          child: ListView(
            ...
            children: [
              ...
              Prises().createEntry(1.5, '(1.) ggf. Pizzabrötchen'),
              Prises().createEntry(1.1, '(2.) ggf. Schokobrötchen/Donuts'),
              Prises().createEntry(1.8, '(3.) ggf. Wraps'),
              Prises().createEntry(1.3, '(4.) ggf. Laugengebäck überbacken'),
